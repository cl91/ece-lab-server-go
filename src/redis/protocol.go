...
func (r *_response) GetBulkData() string    { return r.bulkdata }
func (r *_response) GetMultiBulkData() []string {
...
//
// panics on errors (with redis.Error)
func readBulkData(r *bufio.Reader, n int) (string) {
	if n >= 0 {
		buffsize := n + 2
...
//
// panics on errors (with redis.Error)
func readMultiBulkData(conn *bufio.Reader, num int) []string {
